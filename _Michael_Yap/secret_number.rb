...
puts "Hello there, welcome to Secret Number, a game create by Michael Yap."
...
# If they guess high, let them know
# If they guess low, let them know

3.downto(0) do |turns_left|
